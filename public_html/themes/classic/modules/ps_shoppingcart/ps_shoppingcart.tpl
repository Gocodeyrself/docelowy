...
<div id="_desktop_cart">
  <div class="blockcart cart-preview {if $cart.products_count > -1}active{else}inactive{/if}" data-refresh-url="{$refresh_url}">
    <div class="header">
      ...
      {/if}
        ...
        {if $cart.products_count > 0}
          <span id="shopping-cart-quantity">{$cart.products_count}</span>
        {/if}
