...
<div class="product-line-grid">
  ...
  <div class="product-line-grid-body col-md-4 col-xs-8">
    <div class="product-line-info">
      ...
      <a class="checkout-ean" href="{$product.url}">{l s='Catalog Number:' d='Shop.Theme.Global'} {$product.ean13}</a>
      <a class="checkout-index" href="{$product.url}">Indeks: {$product.reference}</a>
    </div>
