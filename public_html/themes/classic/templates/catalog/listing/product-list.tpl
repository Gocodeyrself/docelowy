...
{block name='content'}
  <section id="main">
    ...
    {block name='subcategory_list'}
      {if isset($subcategories) && $subcategories|@count > 0 && false}
      ...
      {if $listing.products|count}
        ...
        {block name='product_list'}
          <div id="layoutContainer" class="row">
              {assign var="productClasses" value="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-3"}    
          ...
          {include file='catalog/_partials/products.tpl' listing=$listing productClass="{$productClasses}"}
        {/block}
