...
<script type="application/ld+json">
{
  ...
  "description": "{$product.description_short|escape:'html'}",
  "sku": "{$product.reference|escape:'html'}",
  "mpn": "{$product.id|escape:'html'}",
  "brand": {
    "@type": "Brand",
  ...
  "offers": {
    ...
    "shippingDetails": {
      ...
      "shippingDestination": {
        ...
        "addressCountry": {
          "@type": "Country",
          "name": "{if $language.iso_code == 'pl'}Poland{else}International{/if}"
        }
      },
      "deliveryTime": {
