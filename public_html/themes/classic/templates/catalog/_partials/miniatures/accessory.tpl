 ...
 *}
{block name='product_accesorry_item'}
  <div class="product_accessory_item">
    <div class="thumbnail-left col-md-2 p-0">
      ...
      <div class="thumbnail-center col-md-3 p-0">
        <div class="price-container-miniature">
          ...
          <span class="price {if $product.has_discount}red{/if}" aria-label="{l s='Price' d='Shop.Theme.Catalog'}">
    ...
    <div class="thumbnail-left col-md-1 p-0">
      <a href="{$product.url}" content="{$product.url}"><i class="material-icons">&#xE5CC;</i></a>
    </div>
  </div>
{/block}
