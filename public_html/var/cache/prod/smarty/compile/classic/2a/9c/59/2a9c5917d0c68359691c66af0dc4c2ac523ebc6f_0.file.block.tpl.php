...
/* Smarty version 4.3.1, created on 2024-10-17 06:35:20
  from '/home/qisogexqbz/domains/cezos.exis24.pl/public_html/modules/ets_megamenu/views/templates/hook/block.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_67109408c5d359_84336593',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2a9c5917d0c68359691c66af0dc4c2ac523ebc6f' => 
    array (
      0 => '/home/qisogexqbz/domains/cezos.exis24.pl/public_html/modules/ets_megamenu/views/templates/hook/block.tpl',
      1 => 1700227159,
      2 => 'file',
    ),
  ),
...
function content_67109408c5d359_84336593 (Smarty_Internal_Template $_smarty_tpl) {
...
">
        <?php if ($_smarty_tpl->tpl_vars['block']->value['display_title'] && $_smarty_tpl->tpl_vars['block']->value['display_title'] == true) {?>
            <span class="h4" <?php if (Configuration::get('ETS_MM_TEXTTITLE_FONT_SIZE')) {?> style="font-size:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( Configuration::get('ETS_MM_TEXTTITLE_FONT_SIZE') ));?>
px"<?php }?>>
                <?php if ($_smarty_tpl->tpl_vars['block']->value['title_link']) {?><a href="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['block']->value['title_link'],'html','UTF-8' ));?>
" <?php if (Configuration::get('ETS_MM_TEXTTITLE_FONT_SIZE')) {?> style="font-size:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( Configuration::get('ETS_MM_TEXTTITLE_FONT_SIZE') ));?>
px"<?php }?>><?php }?>
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['block']->value['title'],'html','UTF-8' ));?>

                    <?php if ($_smarty_tpl->tpl_vars['block']->value['title_link']) {?></a><?php }?>
            </span>
        <?php }?>
...
"/>
                                        ...
                                        <?php if ((isset($_smarty_tpl->tpl_vars['block']->value['display_mnu_name'])) && $_smarty_tpl->tpl_vars['block']->value['display_mnu_name']) {?>
                                            <span class="ets_item_name"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['manufacturer']->value['label'],'html','UTF-8' ));?>
</span>
                                        <?php }?>
                                    <?php } else { ?>
...
" />
                                        ...
                                        <?php if ((isset($_smarty_tpl->tpl_vars['block']->value['display_suppliers_name'])) && $_smarty_tpl->tpl_vars['block']->value['display_suppliers_name']) {?>
                                            <span class="ets_item_name"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['supplier']->value['label'],'html','UTF-8' ));?>
</span>
                                        <?php }?>
                                    <?php } else { ?>
