...
<section class="featured-products tab-pane fade in clearfix" id="similar">
  ...
  <?php $_smarty_tpl->_subTemplateRender("file:catalog/_partials/productlist.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array('cssClass'=>"owl-carousel",'products'=>$_smarty_tpl->tpl_vars['products']->value,'productClass'=>"col-xs-12"), 0, false);
?>
</section>
<?php }
}
