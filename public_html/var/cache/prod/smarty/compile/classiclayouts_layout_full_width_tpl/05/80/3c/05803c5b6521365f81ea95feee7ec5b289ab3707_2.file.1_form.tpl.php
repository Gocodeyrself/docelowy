...
/* Smarty version 4.3.1, created on 2024-11-22 10:05:34
  from '/home/qisogexqbz/domains/cezos.exis24.pl/public_html/modules/gformbuilderpro/views/templates/front/formtemplates/12/2/1_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6740495ef28fa6_15488809',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '05803c5b6521365f81ea95feee7ec5b289ab3707' => 
    array (
      0 => '/home/qisogexqbz/domains/cezos.exis24.pl/public_html/modules/gformbuilderpro/views/templates/front/formtemplates/12/2/1_form.tpl',
      1 => 1732179160,
      2 => 'file',
    ),
  ),
...
function content_6740495ef28fa6_15488809 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_6131463556740495ef22202_83895021', 'page_content');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, 'page.tpl');
}
/* {block 'page_content'} */
class Block_6131463556740495ef22202_83895021 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page_content' => 
  array (
    0 => 'Block_6131463556740495ef22202_83895021',
  ),
);
...
';<?php echo '</script'; ?>
>
<?php if ((isset($_smarty_tpl->tpl_vars['ispopup']->value)) && $_smarty_tpl->tpl_vars['ispopup']->value) {?> <a href="#gformbuilderpro_form_12" rel="12" class="btn btn-primary gformbuilderpro_openform"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['popup_label']->value, ENT_QUOTES, 'UTF-8');?>
</a>
...
" method="POST" class="form_using_ajax row"><input type="hidden" name="usingajax" value="1"/><input type="hidden" name="idform" value="12"/><input type="hidden" name="id_lang" value="2"/><input type="hidden" name="id_shop" value="1"/><input type="hidden" name="Conditions" value="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['Conditions']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
" class="form-control input_52965 " id="input_52965" placeholder="Name and Surname" name="input_52965" required="required"/></div></div><div id="gformbuilderpro_487" class="itemfield"><div class="form-group input_box"><label for="input_77575" class="required_label">E-mail</label><input type="text" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customeremail']->value, ENT_QUOTES, 'UTF-8');?>
" class="form-control input_52965 " id="input_77575" placeholder="E-mail" name="input_77575" required="required"/></div></div><div id="gformbuilderpro_488" class="itemfield"><div class="form-group input_box"><label for="input_8883">Phone number</label><input type="text" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customer_phone']->value, ENT_QUOTES, 'UTF-8');?>
" class="form-control input_52965 " id="input_8883" placeholder="Phone number" name="input_8883"/></div></div><div id="gformbuilderpro_489" class="itemfield"><div class="form-group input_box"><label for="input_32954">Company name</label><input type="text" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customercompany']->value, ENT_QUOTES, 'UTF-8');?>
" class="form-control input_52965 " id="input_32954" placeholder="Company name" name="input_32954"/></div></div><div id="gformbuilderpro_490" class="itemfield"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>"displayGorderreference",'id'=>"490"),$_smarty_tpl ) );?>
</div><div id="gformbuilderpro_491" class="itemfield"><div class="form-group checkbox_box"><label for="checkbox_82631" class=" required_label">Checkbox Input</label><div class="checkbox_item_wp"><div class="row"><p class="col-xs-12 col-md-12"><input id="checkbox_checkbox_82631_0" type="checkbox" name="checkbox_82631[]" class="checkbox_82631" value="I declare that I have read the above Information Clause and accept the content of the Regulations and Privacy Policy of Cezos.*."/><label for="checkbox_checkbox_82631_0">I declare that I have read the above Information Clause and accept the content of the Regulations and Privacy Policy of Cezos.*.</label></p></div></div></div></div><div id="gformbuilderpro_492" class="itemfield"><div class="form-group checkbox_box"><label for="checkbox_42880" class=" required_label">Checkbox Input</label><div class="checkbox_item_wp"><div class="row"><p class="col-xs-12 col-md-12"><input id="checkbox_checkbox_42880_0" type="checkbox" name="checkbox_42880[]" class="checkbox_82631" value="Having read the above information clause, I declare that I agree to the processing of the personal data provided in the form, including my e-mail address, for the purpose of sending commercial offers electronically.*"/><label for="checkbox_checkbox_42880_0">Having read the above information clause, I declare that I agree to the processing of the personal data provided in the form, including my e-mail address, for the purpose of sending commercial offers electronically.*</label></p></div></div></div></div></div></div><div class="formbuilder_column col-md-6 col-sm-12 col-xs-12"><div class="itemfield_wp"><div id="gformbuilderpro_493" class="itemfield"><div class="form-group input_box"><label for="textarea_84599" class="required_label">Message</label><textarea class="form-control textarea_84599 " name="textarea_84599" id="textarea_84599" placeholder="Enter your message" required="required" rows="7"></textarea></div></div></div></div></div><div class="formbuilder_group"><div class="formbuilder_column col-md-12 col-sm-12 col-xs-12"><div class="itemfield_wp"><div id="gformbuilderpro_513" class="itemfield"><?php if ((isset($_smarty_tpl->tpl_vars['using_v3']->value)) && $_smarty_tpl->tpl_vars['using_v3']->value) {?>
