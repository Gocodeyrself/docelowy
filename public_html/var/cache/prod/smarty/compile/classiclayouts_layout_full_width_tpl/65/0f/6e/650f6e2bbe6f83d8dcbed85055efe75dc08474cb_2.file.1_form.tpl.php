<?php
/* Smarty version 4.3.1, created on 2024-11-22 09:03:37
  from '/home/qisogexqbz/domains/cezos.exis24.pl/public_html/modules/gformbuilderpro/views/templates/front/formtemplates/13/2/1_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_67403ad9253495_54939436',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '650f6e2bbe6f83d8dcbed85055efe75dc08474cb' => 
    array (
      0 => '/home/qisogexqbz/domains/cezos.exis24.pl/public_html/modules/gformbuilderpro/views/templates/front/formtemplates/13/2/1_form.tpl',
      1 => 1732181858,
      2 => 'file',
    ),
  ),
...
function content_67403ad9253495_54939436 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_112538377167403ad924a982_26873527', 'page_content');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, 'page.tpl');
}
/* {block 'page_content'} */
class Block_112538377167403ad924a982_26873527 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page_content' => 
  array (
    0 => 'Block_112538377167403ad924a982_26873527',
  ),
);
...
" method="POST" class="form_using_ajax row"><input type="hidden" name="usingajax" value="1"/><input type="hidden" name="idform" value="13"/><input type="hidden" name="id_lang" value="2"/><input type="hidden" name="id_shop" value="1"/><input type="hidden" name="Conditions" value="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['Conditions']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
" class="form-control input_52965 " id="input_93172_1730317259" placeholder="Name and Surname" name="input_93172_1730317259" required="required"/></div></div><div id="gformbuilderpro_499" class="itemfield"><div class="form-group input_box"><label for="input_381746_1730317259" class="required_label">E-mail</label><input type="text" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customeremail']->value, ENT_QUOTES, 'UTF-8');?>
" class="form-control input_52965 " id="input_381746_1730317259" placeholder="E-mail" name="input_381746_1730317259" required="required"/></div></div><div id="gformbuilderpro_500" class="itemfield"><div class="form-group input_box"><label for="input_486438_1730317259">Phone number</label><input type="text" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customer_phone']->value, ENT_QUOTES, 'UTF-8');?>
" class="form-control input_52965 " id="input_486438_1730317259" placeholder="Phone number" name="input_486438_1730317259"/></div></div><div id="gformbuilderpro_501" class="itemfield"><div class="form-group input_box"><label for="input_217150_1730317259">Company name</label><input type="text" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customercompany']->value, ENT_QUOTES, 'UTF-8');?>
" class="form-control input_52965 " id="input_217150_1730317259" placeholder="Company name" name="input_217150_1730317259"/></div></div><div id="gformbuilderpro_502" class="itemfield"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>"displayGorderreference",'id'=>"502"),$_smarty_tpl ) );?>
</div><div id="gformbuilderpro_503" class="itemfield"><div class="form-group checkbox_box"><label for="checkbox_519317_1730317259" class=" required_label">Checkbox Input</label><div class="checkbox_item_wp"><div class="row"><p class="col-xs-12 col-md-12"><input id="checkbox_checkbox_519317_1730317259_0" type="checkbox" name="checkbox_519317_1730317259[]" class="checkbox_82631" value="I declare that I have read the above Information Clause and accept the content of the Regulations and Privacy Policy of Cezos.*."/><label for="checkbox_checkbox_519317_1730317259_0">I declare that I have read the above Information Clause and accept the content of the Regulations and Privacy Policy of Cezos.*.</label></p></div></div></div></div><div id="gformbuilderpro_504" class="itemfield"><div class="form-group checkbox_box"><label for="checkbox_429353_1730317259" class=" required_label">Checkbox Input</label><div class="checkbox_item_wp"><div class="row"><p class="col-xs-12 col-md-12"><input id="checkbox_checkbox_429353_1730317259_0" type="checkbox" name="checkbox_429353_1730317259[]" class="checkbox_82631" value="Having read the above information clause, I declare that I agree to the processing of the personal data provided in the form, including my e-mail address, for the purpose of sending commercial offers electronically.*"/><label for="checkbox_checkbox_429353_1730317259_0">Having read the above information clause, I declare that I agree to the processing of the personal data provided in the form, including my e-mail address, for the purpose of sending commercial offers electronically.*</label></p></div></div></div></div></div></div><div class="formbuilder_column col-md-6 col-sm-12 col-xs-12"><div class="itemfield_wp"><div id="gformbuilderpro_505" class="itemfield"><div class="form-group input_box"><label for="textarea_product_text" class="required_label">Message</label><textarea class="form-control textarea_84599 " name="textarea_35564_1730317259" id="textarea_product_text" placeholder="Enter your message" required="required" rows="7"></textarea></div></div></div></div></div><div class="formbuilder_group"><div class="formbuilder_column col-md-12 col-sm-12 col-xs-12"><div class="itemfield_wp"><div id="gformbuilderpro_514" class="itemfield"><?php if ((isset($_smarty_tpl->tpl_vars['using_v3']->value)) && $_smarty_tpl->tpl_vars['using_v3']->value) {?>
