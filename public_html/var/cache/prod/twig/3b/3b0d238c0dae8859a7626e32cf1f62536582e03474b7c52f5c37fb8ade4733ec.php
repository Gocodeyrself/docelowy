...
class __TwigTemplate_2700aebdcb1dd44312f9211354648e59c94037e7bf3ce816de7e65c5bbdfd737 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        // line 95
        echo "    ";
        if (( !(null === twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "customer", [], "any", false, false, false, 95)) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "customer", [], "any", false, false, false, 95), "id", [], "any", false, false, false, 95), 0)))) {
            // line 96
            echo "      ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Order/Order/view.html.twig", "/home/qisogexqbz/domains/cezos.exis24.pl/public_html/src/PrestaShopBundle/Resources/views/Admin/Sell/Order/Order/view.html.twig");
    }
}
