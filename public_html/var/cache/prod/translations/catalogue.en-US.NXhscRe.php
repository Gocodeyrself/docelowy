...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  array (
    'Edit your products, enter a discount code if you have one, or proceed to checkout.' => 'Edit your products and proceed to checkout.',
  ...
  array (
    'Please send us a bank wire with:' => 'Please process the payment to our account:',
    'Name of account owner' => 'Beneficiary',
    'Please include these details' => 'Please ensure that the correct account number is selected for the currency in which the payment is being made to avoid errors.',
    'Please process the payment to our account:' => 'Use the information below to make the payment. In the table, you will find the amount to be paid, the recipient, the appropriate account number to choose from, and the unique order number that should be included in the payment title.',
