...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_66b4b6a47b5231_30391109',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b661a84faa3ed4cde2caa3a36acf0abed994100f' => 
    array (
      0 => '/home/qisogexqbz/domains/cezos.exis24.pl/public_html/themes/classic/templates/catalog/_partials/category-header.tpl',
      1 => 1716551002,
      2 => 'file',
    ),
  ),
...
function content_66b4b6a47b5231_30391109 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <?php if ($_smarty_tpl->tpl_vars['listing']->value['pagination']['items_shown_from'] == 1) {?>
        <div class="block-category card card-block">
            ...
            <div class="block-category-inner">
                <?php if ($_smarty_tpl->tpl_vars['category']->value['description'] && false) {?>
                    <div id="category-description" class="text-muted"><?php echo $_smarty_tpl->tpl_vars['category']->value['description'];?>
</div>
                <?php }?>
                <?php if (!empty($_smarty_tpl->tpl_vars['category']->value['image']['large']['url']) && false) {?>
