...
class __TwigTemplate_f7e019670ae7ad3f25b2baa614381a9195b693ca97b5391af6b2d7f2e09e3671 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        if ((isset($context["isSingleShopContext"]) || array_key_exists("isSingleShopContext", $context) ? $context["isSingleShopContext"] : (function () { throw new RuntimeError('Variable "isSingleShopContext" does not exist.', 29, $this->source); })())) {
            // line 30
            echo "    ";
            if ((-1 === twig_compare(twig_length_filter($this->env, (isset($context["paymentModules"]) || array_key_exists("paymentModules", $context) ? $context["paymentModules"] : (function () { throw new RuntimeError('Variable "paymentModules" does not exist.', 30, $this->source); })())), 2))) {
                // line 31
...
{% block content %}
  ...
  {% endif %}
{% endblock %}
", "@PrestaShop/Admin/Improve/Payment/PaymentMethods/payment_methods.html.twig", "/home/qisogexqbz/domains/cezos.exis24.pl/public_html/src/PrestaShopBundle/Resources/views/Admin/Improve/Payment/PaymentMethods/payment_methods.html.twig");
    }
}
