...
class __TwigTemplate_b8bdab1b3886a2c65dc46dbe452e11681d902013366bce7c62840a0db34ba29b extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"col-lg-6\">
    ...
    <div class=\"card\" id=\"checkConfiguration\">
      ...
      <div class=\"card-body\">
        ";
        // line 198
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["requirements"]) || array_key_exists("requirements", $context) ? $context["requirements"] : (function () { throw new RuntimeError('Variable "requirements" does not exist.', 198, $this->source); })()), "failRequired", [], "any", false, false, false, 198), false))) {
            // line 199
            echo "          <p class=\"mb-0\">
            <strong>";
            // line 200
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["requirements"] ?? null), "failOptional", [], "any", true, true, false, 216)) {
            // line 217
            echo "          ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["requirements"]) || array_key_exists("requirements", $context) ? $context["requirements"] : (function () { throw new RuntimeError('Variable "requirements" does not exist.', 217, $this->source); })()), "failOptional", [], "any", false, false, false, 217), false))) {
                // line 218
                echo "            <p class=\"mb-0\">
              <strong>";
                // line 219
...
{% endblock %}
", "@PrestaShop/Admin/Configure/AdvancedParameters/system_information.html.twig", "/home/qisogexqbz/domains/cezos.exis24.pl/public_html/src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters/system_information.html.twig");
    }
}
