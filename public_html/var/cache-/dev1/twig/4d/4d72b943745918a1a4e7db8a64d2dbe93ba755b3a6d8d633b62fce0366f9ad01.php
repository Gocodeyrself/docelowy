...
class __TwigTemplate_f788a870a87b0d96a1e83a8b765a47df200c4c188eadadfa09428594ddb719e4 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 27
        if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["backOfficeOrderButtons"]) || array_key_exists("backOfficeOrderButtons", $context) ? $context["backOfficeOrderButtons"] : (function () { throw new RuntimeError('Variable "backOfficeOrderButtons" does not exist.', 27, $this->source); })()), "isEmpty", [], "method", false, false, false, 27), true))) {
            // line 28
            echo "
  ";
            // line 29
            ...
            // line 30
            echo "  ";
            if ((1 === twig_compare(twig_length_filter($this->env, (isset($context["buttons"]) || array_key_exists("buttons", $context) ? $context["buttons"] : (function () { throw new RuntimeError('Variable "buttons" does not exist.', 30, $this->source); })())), 2))) {
                // line 31
                echo "
    ";
                // line 32
...
{% endif %}
", "@PrestaShop/Admin/Sell/Order/Order/Blocks/View/extra_order_button_actions.html.twig", "/home/qisogexqbz/domains/cezos.exis24.pl/public_html/src/PrestaShopBundle/Resources/views/Admin/Sell/Order/Order/Blocks/View/extra_order_button_actions.html.twig");
    }
}
