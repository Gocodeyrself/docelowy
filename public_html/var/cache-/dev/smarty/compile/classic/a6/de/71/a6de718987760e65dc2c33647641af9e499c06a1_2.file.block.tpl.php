...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_66b4b6b1f1a581_17311473',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a6de718987760e65dc2c33647641af9e499c06a1' => 
    array (
...
function content_66b4b6b1f1a581_17311473 (Smarty_Internal_Template $_smarty_tpl) {
...
">
        <?php if ($_smarty_tpl->tpl_vars['block']->value['display_title'] && $_smarty_tpl->tpl_vars['block']->value['display_title'] == true) {?>
            <span class="h4" <?php if (Configuration::get('ETS_MM_TEXTTITLE_FONT_SIZE')) {?> style="font-size:<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( Configuration::get('ETS_MM_TEXTTITLE_FONT_SIZE') )), ENT_QUOTES, 'UTF-8');?>
px"<?php }?>>
                <?php if ($_smarty_tpl->tpl_vars['block']->value['title_link']) {?><a href="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['block']->value['title_link'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
" <?php if (Configuration::get('ETS_MM_TEXTTITLE_FONT_SIZE')) {?> style="font-size:<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( Configuration::get('ETS_MM_TEXTTITLE_FONT_SIZE') )), ENT_QUOTES, 'UTF-8');?>
px"<?php }?>><?php }?>
                    <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['block']->value['title'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
