...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_66b4b6b1eae4e6_23119866',
...
function content_66b4b6b1eae4e6_23119866 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
            <?php if (mb_strtolower((string) $_smarty_tpl->tpl_vars['menu']->value['title'], 'UTF-8') == "searchwidget") {?>
                <li class="mm_menus_li mm_menus_li_search mm_menus_li_special"
...
echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['menu']->value['menu_item_width'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');
            ...
            <?php } elseif (mb_strtolower((string) $_smarty_tpl->tpl_vars['menu']->value['title'], 'UTF-8') == "logo") {?>
                <li class="mm_menus_li mm_menus_li_logo mm_menus_li_special"
                <?php if ($_smarty_tpl->tpl_vars['menu']->value['enabled_vertical']) {?>style="width: <?php if ($_smarty_tpl->tpl_vars['menu']->value['menu_item_width']) {
echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['menu']->value['menu_item_width'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');
} else { ?>auto;<?php }?>"<?php }?>>
                                   </li>
            <?php } elseif (mb_strtolower((string) $_smarty_tpl->tpl_vars['menu']->value['title'], 'UTF-8') == "displaytopright") {?>
                <li class="mm_menus_li mm_menus_li_icons mm_menus_li_special"
                <?php if ($_smarty_tpl->tpl_vars['menu']->value['enabled_vertical']) {?>style="width: <?php if ($_smarty_tpl->tpl_vars['menu']->value['menu_item_width']) {
echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['menu']->value['menu_item_width'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');
} else { ?>auto;<?php }?>"<?php }?>>
                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayTopRight'),$_smarty_tpl ) );?>
            ...
            <?php } else { ?>
                <li class="mm_menus_li<?php if ($_smarty_tpl->tpl_vars['menu']->value['enabled_vertical']) {?> mm_menus_li_tab<?php if ($_smarty_tpl->tpl_vars['menu']->value['menu_ver_hidden_border']) {?> mm_no_border<?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['menu']->value['menu_ver_alway_show']) {?> menu_ver_alway_show_sub<?php }
}
if ($_smarty_tpl->tpl_vars['menu']->value['custom_class']) {?> <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['menu']->value['custom_class'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');
                    ...
                    <?php if ((isset($_smarty_tpl->tpl_vars['menu']->value['enabled_vertical'])) && $_smarty_tpl->tpl_vars['menu']->value['enabled_vertical'] && (isset($_smarty_tpl->tpl_vars['menu']->value['tabs'])) && $_smarty_tpl->tpl_vars['menu']->value['tabs'] || $_smarty_tpl->tpl_vars['menu']->value['columns']) {?> mm_has_sub<?php }?>
                    <?php if ((isset($_smarty_tpl->tpl_vars['menu']->value['display_tabs_in_full_width'])) && $_smarty_tpl->tpl_vars['menu']->value['display_tabs_in_full_width'] && (isset($_smarty_tpl->tpl_vars['menu']->value['enabled_vertical'])) && $_smarty_tpl->tpl_vars['menu']->value['enabled_vertical']) {?> display_tabs_in_full_width<?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['menu']->value['display_tabs_in_full_width'] && $_smarty_tpl->tpl_vars['menu']->value['enabled_vertical']) {?> display_tabs_in_full_width<?php }?>
