    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                72 => (\dirname(__DIR__, 4).'/modules/smartsupp/translations'),
                73 => (\dirname(__DIR__, 4).'/modules/przelewy24/translations'),
                74 => (\dirname(__DIR__, 4).'/modules/inpostshipping/translations'),
                75 => (\dirname(__DIR__, 4).'/modules/arlg/translations'),
                76 => (\dirname(__DIR__, 4).'/modules/categoriesbanners/translations'),
                77 => (\dirname(__DIR__, 4).'/modules/fblogin/translations'),
                78 => (\dirname(__DIR__, 4).'/modules/glogin/translations'),
                79 => (\dirname(__DIR__, 4).'/modules/ph_simpleblog/translations'),
                80 => (\dirname(__DIR__, 4).'/modules/phblogrecentposts/translations'),
                81 => (\dirname(__DIR__, 4).'/modules/blockwishlist/translations'),
                82 => (\dirname(__DIR__, 4).'/modules/sensbitgls/translations'),
                83 => (\dirname(__DIR__, 4).'/modules/blog_images/translations'),
                84 => (\dirname(__DIR__, 4).'/modules/pi_gusloader/translations'),
