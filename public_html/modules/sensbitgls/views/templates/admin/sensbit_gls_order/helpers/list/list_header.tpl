							...
							<div class="btn-group"  data-toggle="buttons">
								...
								<div style='width:170px;display:inline-block'>
									<div class="input-group">
										...
										<input type='text' class='sensbitgls-datetime' value="{if isset($filters.date_add)}{$filters.date_add.from}{/if}"  name='filters[date_add][from]' placeholder='Od'/>
									</div>
								</div>
								<div  style='width:170px;display:inline-block'>
									<div class="input-group">
										<span class="input-group-addon">Do</span>
										<input type='text' class='sensbitgls-datetime' value="{if isset($filters.date_add)}{$filters.date_add.to}{/if}"  name='filters[date_add][to]' placeholder='Do'/>
									</div>
								</div>
							</div>
						</div>
