	...
	<div class="panel">
		...
		<div class="panel-body">
			<div class="alert alert-info">
				<p>Wraz z wersją  1.9.1 modułu wprowdziliśmy nową funkcjonalność, a mianowicie dostęp do danych modułu z zewnątrz tj. spoza panelu administracyjnego sklepu PrestaShop.</p>
...
<script>
	...
	{if SensbitGlsTools::isBootstrap()}
		$(".sensbitgls-parent").insertBefore("#form-sensbitgls_status table.table");
	{else}
		$(".sensbitgls-parent").insertBefore("table[name=list_table]");
	{/if}
