...
{
    SensbitGlsTools::installSql(array(
        'ALTER TABLE `'._DB_PREFIX_.'sensbitgls_shipment` DROP PRIMARY KEY, ADD PRIMARY KEY (`id_shipment`)',
        'ALTER TABLE `'._DB_PREFIX_.'sensbitgls_shipment` ADD INDEX (`id_order`)'
    ));
    return true;
}
