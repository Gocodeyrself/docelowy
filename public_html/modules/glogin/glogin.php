...
class glogin extends Module
{
    ...
    public function install()
    {
        ...
        if (!parent::install() || !$this->registerHook('header') || !$this->registerHook('dashboardZoneOne') || !$this->runSql($sql) || !$this->installModuleHooks() || !Configuration::updateValue('glogin_groupid', Configuration::get('PS_CUSTOMER_GROUP'))) {
            return false;
        }
        return true;
    }
                        ...
                        <form action="' . Tools::safeOutput($_SERVER['REQUEST_URI']) . '" method="post">
                           ...
                           <div style="clear:both; margin-bottom:20px;">
                                ...
                                <div style="clear:both; margin-bottom:20px;">
                                    ...
                                    <tr>
                                        <td><img src="../modules/glogin/img/button-small.jpg"/></td>
                                        <td><img src="../modules/glogin/img/button-large.jpg"/></td>
                                    </tr>
                                    </table>
                                    </div>
                    				</div>
