...
<div class="ar-modules-title">{l s='modules that may interest you:' mod='arlg'}</div>
        ...
        <a href="{$module->url|escape:'htmlall':'UTF-8'}" target="_blank">
            ...
            <div class="areama-module-content">
                ...
                <div class="areama-module-rate">
                    ...
                    <span class="ar-votes">({$module->rate_count|escape:'htmlall':'UTF-8'} {l s='votes' mod='arlg'})</span>
                </div>
                {/if}
