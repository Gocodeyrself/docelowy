...
// Tabela zapisanych koszyków (zmodyfikowana)
$sql[] = '
    CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'ets_savemycart_cart` (
        `id_saved_cart` int(11) unsigned NOT NULL AUTO_INCREMENT,
        `id_cart` int(11) unsigned NOT NULL,
