...
class AdminGformanalyticsController extends ModuleAdminController
{
    ...
    public function initTabModuleList(){
        if(version_compare(_PS_VERSION_,'1.5.4.0') == -1 || version_compare(_PS_VERSION_, '8.0.0 ', '>='))
            return true;
        else
    ...
    public function postProcess()
    {
        if(Tools::isSubmit('gremoveAnalyticsAatas')){
            ...
            die(json_encode(array('error' => 0, 'warrning' => $this->l('Remove history Successfully'))));
            ...
            if($banned == false || $banned == 'false' || $banned == '0') {
                ...
                die(json_encode(array('error' => 0, 'warrning' => $this->l('Ban Ip Successfully'))));
            }else{
                ...
                die(json_encode(array('error' => 0, 'warrning' => $this->l('UnBan Ip Successfully'))));
            }
        }
        parent::postProcess();
