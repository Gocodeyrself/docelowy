    ...
    {/if}
        ...
        <form action="" method="POST" name="gformbuilderpro_reply_form">
            ...
            <div class="form-group gformbuilderpro_reply_wp" style="margin-top: 10px;">
                ...
                <div class="col-lg-8">
                    <textarea id="gformbuilderpro_reply" name="gformbuilderpro_reply" class="rte autoload_rte gautoload_rte">
                        {$email_template nofilter}{* $request is html content, no need to escape*}
                    </textarea>
                </div>
            </div>
            <div style="clear:both;"></div>
            <div class="form-group gformbuilderpro_reply_wp" style="margin-top: 10px;">
                ...
                <div class="col-lg-8">
                    <button type="submit" class="btn btn-primary submit_reply"><i class="icon-reply"></i>{l s='Reply & save'  mod='gformbuilderpro'}</button>
                </div>
            </div>
