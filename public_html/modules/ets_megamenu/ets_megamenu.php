...
class Ets_megamenu extends Module
{
    ...
    public function hookDisplayMegaMenu()
    {
        if (Configuration::get('ETS_MM_HOOK_TO') == 'customhook')
            return $this->displayMenuFrontend();
        if (Configuration::get('ETS_MM_HOOK_TO') == 'default')
            return $this->displayMenuFrontend();
    }
    
    public function hookDisplayIndexMenu(){
        $this->smarty->assign(array(
            'menusHTML' => $this->displayMegaMenuIndex(),
            'mm_layout_direction' => $this->layoutDirection(),
            'mm_multiLayout' => MM_Obj::multiLayoutExist(),
        ));
        return $this->display(__FILE__, 'megamenu_index.tpl');
    }

    public function displayMegaMenuIndex($id_lang = false)
    {
        ...
        // {
            ...
            $menus = $id_lang ? MM_Menu::getMenus(true, $id_lang, 1) : MM_Menu::getMenus(true, 1, 1);
        ...
        // }
        return $this->display(__FILE__, 'menu-html_index.tpl');
    }
