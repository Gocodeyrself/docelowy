    ...
    <div id="send_AAP_form" class="card">
        <div class="card-block">
            ...
            <div class="col-lg-12 send_AAP_form_content_button">
                {if $aapfree_recaptcha == true}
                    <div class="g-recaptcha" data-sitekey="{$aapfree_recaptcha_sitekey}"></div>
                    <script type="text/javascript" src="//www.google.com/recaptcha/api.js?hl={$aapfree_recaptcha_lang}"></script>
                {/if}
